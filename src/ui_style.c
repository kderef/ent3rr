...
static const GuiStyleProp terminalStyleProps[TERMINAL_STYLE_PROPS_COUNT] = {
    { 0, BORDER_COLOR_NORMAL, 0x1c8d00ff },
    { 0, BASE_COLOR_NORMAL, 0x161313ff },
    { 0, TEXT_COLOR_NORMAL, 0x38f620ff },
    { 0, BORDER_COLOR_FOCUSED, 0xc3fbc6ff },
    { 0, BASE_COLOR_FOCUSED, 0x43bf2eff },
    { 0, TEXT_COLOR_FOCUSED, 0xdcfadcff }, 
    { 0, BORDER_COLOR_PRESSED, 0x1f5b19ff },   
    { 0, BASE_COLOR_PRESSED, 0x43ff28ff },    
    { 0, TEXT_COLOR_PRESSED, 0x1e6f15ff },   
    { 0, BORDER_COLOR_DISABLED, 0x223b22ff },
    { 0, BASE_COLOR_DISABLED, 0x182c18ff },   
    { 0, TEXT_COLOR_DISABLED, 0x244125ff },   
    { 0, TEXT_SIZE, 0x00000010 },  
    { 0, TEXT_SPACING, 0x00000000 }, 
    { 0, LINE_COLOR, 0xe6fce3ff },   
    { 0, BACKGROUND_COLOR, 0x0c1505ff },    
...
static const GuiStyleProp redTerminalStyleProps[TERMINAL_STYLE_RED_PROPS_COUNT] = {
    { 0, BORDER_COLOR_NORMAL, 0x8d1c00ff },
    { 0, BASE_COLOR_NORMAL, 0x131313ff },
    { 0, TEXT_COLOR_NORMAL, 0xf63820ff },
    { 0, BORDER_COLOR_FOCUSED, 0xfbc3c6ff },
    { 0, BASE_COLOR_FOCUSED, 0xbf2e2eff },
    { 0, TEXT_COLOR_FOCUSED, 0xfadcdcff },
    { 0, BORDER_COLOR_PRESSED, 0x5b1f19ff },
    { 0, BASE_COLOR_PRESSED, 0xff2828ff },
    { 0, TEXT_COLOR_PRESSED, 0x6f1e15ff },
    { 0, BORDER_COLOR_DISABLED, 0x3b2222ff },
    { 0, BASE_COLOR_DISABLED, 0x2c1818ff },
    { 0, TEXT_COLOR_DISABLED, 0x412524ff },
    { 0, LINE_COLOR, 0xfce6e3ff },
    { 0, BACKGROUND_COLOR, 0x150c05ff },
    //{ 0, TEXT_LINE_SPACING, 0x00000018 },
    //{ 0, TEXT_SIZE, 0x00000010 },
    //{ 0, TEXT_SPACING, 0x00000000 },
};
...
FN void ui_set_colortheme(UiColortheme theme) {
    ...
    switch (theme) {
        case COLORTHEME_GREENTERM: {
            props_count = TERMINAL_STYLE_PROPS_COUNT;
            props = terminalStyleProps;
        } break;
...
FN void ui_load_style_terminal(Font* custom_font) {
